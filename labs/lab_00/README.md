...
- [GitHub](#github)
  ...
  - [Login and Authenticate](#login-and-authenticate)
...
To be able to push commits to your repo, you'll need to be logged in and authenticated from your terminal session. To do that, you first need to create a Personal Access Token (PAT). A Classic PAT is sufficient for this purpose, just be sure you've selected all the options necessary to maintain your project. If unsure, select everything. GitHub will only show you your PAT once after it is created, so remember to save it somewhere. I recommend using a password manager of some sort. Once you have your PAT, use

```bash
gh auth login
```

Select `github.com`, which is the default hostname, `HTTPS`, which is the default authentication mode. Indicate that you wish to use a PAT, and paste in your PAT when prompted. You are now authenticated 

### Extensions

The following VS Code Extensions are useful when working with GitHub and its repositories:

* [Git History](https://marketplace.visualstudio.com/items?itemName=donjayamanne.githistory) by Don Jayamanne - View git log, file history, compare branches or commits
* [GitHub Actions](https://marketplace.visualstudio.com/items?itemName=GitHub.vscode-github-actions) by GitHub - GitHub Actions workflows and runs for github.com repos in VS Code
* [GitHub Codespaces](https://marketplace.visualstudio.com/items?itemName=GitHub.codespaces) by GitHub - Your instant dev environment
* [GitHub Copilot modernization](https://marketplace.visualstudio.com/items?itemName=vscjava.migrate-java-to-azure) by Microsoft - Upgrade and migrate your applications to Azure
* [GitHub Pull Requests](https://marketplace.visualstudio.com/items?itemName=GitHub.vscode-pull-request-github) by GitHub - Pull Request and Issue Provider for GitHub
* [GitHub Repositories](https://marketplace.visualstudio.com/items?itemName=GitHub.remotehub) by GitHub - Remotely browse and edit any GitHub repository
* [gitignore](https://marketplace.visualstudio.com/items?itemName=codezombiech.gitignore) by CodeZombie - Pulls .gitignore templates from GitHub's [gitignore](https://github.com/github/gitignore) repository
* [GitLens - Git supercharged](https://marketplace.visualstudio.com/items?itemName=eamodio.gitlens) by GitKraken - Supercharge Git within VS Code
...
* [Data Wrangler](https://marketplace.visualstudio.com/items?itemName=ms-toolsai.datawrangler) by Microsoft - Data viewing, cleaning and preparation for tabular datasets
* [indent-rainbow](https://marketplace.visualstudio.com/items?itemName=oderwat.indent-rainbow) by oderwat - Makes indentation easier to read
* [Markdown All in One](https://marketplace.visualstudio.com/items?itemName=yzhang.markdown-all-in-one) by Yu Zhang - All you need to write Markdown (It's not, but does a lot!)
* [Markdown PDF](https://marketplace.visualstudio.com/items?itemName=yzane.markdown-pdf) by yzane - Convert Markdown to PDF
* [Markdown Preview Mermaid](https://marketplace.visualstudio.com/items?itemName=bierner.markdown-mermaid) by Matt Bierner - Adds Mermaid diagram and flowchart support to VS Code's builtin Markdown preview
* [markdownlint](https://marketplace.visualstudio.com/items?itemName=DavidAnson.vscode-markdownlint) by David Anson - Markdown linting and style checking
* [Print](https://marketplace.visualstudio.com/items?itemName=pdconsec.vscode-print) by PD Consulting - Prints rendered Markdown and colored code
* [Rainbow CSV](https://marketplace.visualstudio.com/items?itemName=mechatroner.rainbow-csv) by mechatroner - Highlight CSV and TSV files. Run SQL-like queries
* [Scientific Terms - Code Spell Checker](https://marketplace.visualstudio.com/items?itemName=streetsidesoftware.code-spell-checker-scientific-terms) by Street Side Software - Scientific terms dictionary
* [Trailing Spaces](https://marketplace.visualstudio.com/items?itemName=shardulm94.trailing-spaces) by Shardul Mahadik - Highlights whitespace at the end of a line
* [vscode-icons](https://marketplace.visualstudio.com/items?itemName=vscode-icons-team.vscode-icons) by VSCode Icons Team - Icons for Visual Studio Code
* [vscode-pdf](https://marketplace.visualstudio.com/items?itemName=tomoki1207.pdf) by tomoki1207 - Display pdf file in VSCode

If you're a fan of VI or Vim

* [Vim](https://marketplace.visualstudio.com/items?itemName=vscodevim.vim) by vscodevim - Vim emulation for Visual Studio Code
